...
/// later aggregated to compute the power of 2 of the top value of the stack. In the unchecked
/// mode, we skip the check of verifying that the top element is less than 64.
///
/// VM cycles per mode:
