...
/// Tests a u32min assembly operation (u32checked_min or u32unchecked_) against a number of cases
/// to ensure that the operation puts the minimum of 2 input values on the stack.
